...
function nextpage1(){
  ...
  beginner_button.position(700,200)
  beginner_button.scale = 1.5
  beginner_button.visible = true

  intermediate_button = createButton("Intermediate")
  intermediate_button.position(690,400)
  intermediate_button.scale = 1.5
  intermediate_button.visible = true

  advance_button = createButton("Advanced")
  advance_button.position(700,600)
  advance_button.scale = 1.5
  intermediate_button.visible = true
